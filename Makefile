...
# of dead quill entries in System Settings). Signing with a real identity gives
...
PREFIX  ?= $(HOME)/.local
BINDIR   = $(PREFIX)/bin
BUILT    = .build/release/quill
INSTALLED = $(BINDIR)/quill
...
# coherent "quill" rather than a path.
#
